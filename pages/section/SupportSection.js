    ...
    return (
        <section className="pb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {details.map((detail) => (
                    <div className="bg-white shadow-md rounded-lg p-4 text-center border-2 border-turqoise hover:border-black dark:hover:border-white bg-transparent transition duration-500">  
