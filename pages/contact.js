    ...
    return (
        <main className='flex items-center justify-center h-[calc(100vh-94px)]'>
            <div className='bg-white p-2 rounded-md shadow-[0_10px_20px_rgba(0,0,0,0.25)]'>
                <h1 className='bg-turqoise-gradient rounded-md py-4 px-8 font-bold text-3xl text-center text-white shadow-outside-glow hover:scale-95 transition duration-300'>CONTACT US</h1>
                ...
                <div className='text-black flex flex-col gap-2'>
                    <button
                        ...
                        className='button-animation w-full flex items-center px-4 py-2 rounded-md font-medium justify-center text-lg hover:text-white transition-all duration-200'
                    >
                        <span className='button-content gap-2'>
                            <FaInstagram size={24} />
